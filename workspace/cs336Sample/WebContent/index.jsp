...
<% out.println("Home Page"); %> <!-- output the same thing, but using 
                                      jsp programming -->

<br>
<button type="button" onclick="login.jsp">Login</button>
<p>Don't have an account? Register
<button type="button" onclick="register.jsp">Register</button>
</p>

<br>
<form method="get" action="chooseAccount.jsp">
  <input type="radio" name="command" value="beers"/>Admin Login
  <br>
  <input type="radio" name="command" value="beers"/>Rep Login
  <br>
  <input type="radio" name="command" value="user"/>User Login
